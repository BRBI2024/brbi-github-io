...
if(isset($_POST['submit']))          
{
		...
		if(empty($_POST['d_name'])||empty($_POST['unit_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['res_name']=='')
		{	
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,unit_id,title,slogan,price,img) VALUE('".$_POST['res_name']."','".$_POST['unit_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Supply</h4>
                            </div>
                            <div class="card-body">
