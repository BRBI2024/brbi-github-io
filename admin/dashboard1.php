...
<body class="fix-header fix-sidebar">
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="dashboard1.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Approved Orders</span></a></li>
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT users.*, users_orders.*, dishes.unit_id 
                                    FROM users 
                            ...
                            <!-- <div class="text-right">
                                ...
                                <div class="text-right">
                                    <p style="font-weight: bold;">Grand Total: ₱<?php echo number_format($grandTotal, 2); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function downloadExcel() {
            ...
            window.location.href = `download_excel1.php?search_username=${searchUser}&start_date=${startDate}&end_date=${endDate}`;
        }
    </script>
</body>
</html>