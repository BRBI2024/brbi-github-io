...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/office1.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Supplier</h4> </div>
                
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" fill="currentColor" class="bi bi-diagram-3" viewBox="0 0 16 16">
                            ...
                            <h4><span style="color:white;">2. </span>Order Item</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Pick-up or Deliver</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Items of the Month</h2>
                    <p class="lead">Easiest way to order the supplies that you need</p>
                </div>
                <div class="row">
						<?php 					
